...
<body>
    ...
    <asp:TextBox ID="TextBox2" CssClass="sizeInput" runat="server" placeholder="Password"></asp:TextBox>
        <br />
    <p style="text-align:center;"><asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="sizeButton"/></p>
  ...
  <script type="text/javascript" src="http://www.yourweather.co.uk/wid_loader/09e789b327b5ecf43d757a8414785bab"></script>
    ...
    <p style="margin-bottom:30px;">If you have any suggestion or query about our service, please feel comfortable to contact with us.</p>
    <div class="subform" style="background:#dedede;">
    
        <asp:Label ID="lblName" CssClass="label" runat="server" Text="Enter your name"></asp:Label><asp:TextBox ID="txtName" CssClass="textbox" runat="server"></asp:TextBox>
        <br />
        <br />
        ...
        <asp:TextBox ID="txtMessage" CssClass="textbox" runat="server" 
            TextMode="MultiLine" Columns="8" Rows="15"></asp:TextBox>
        
        <asp:Button ID="Button1" runat="server" Text="Send" style="margin-top:10px;"/>
      </div>
