...
.subform input[type=text]:focus, input[type=password]:focus,textarea:focus {
  border-color: #7dc9e2;
...
<body>
  ...
  <script type="text/javascript" src="http://www.yourweather.co.uk/wid_loader/09e789b327b5ecf43d757a8414785bab"></script>
    ...
    <legend>Required information</legend>
        <asp:Label ID="lblAddTitle" CssClass="label" runat="server" Text="Enter Advertise title"></asp:Label><asp:TextBox ID="txtAddTitle" TextMode="MultiLine" Columns="8" Rows="4" CssClass="textbox" runat="server"></asp:TextBox>
        <br />
        <asp:Label ID="lblAddDes" CssClass="label" runat="server" Text="Enter advertise description"></asp:Label><asp:TextBox ID="txtAddDes" TextMode="MultiLine" Columns="8" Rows="15" CssClass="textbox" runat="server"></asp:TextBox>
        <br />
        <asp:Label ID="lblAddLocation" CssClass="label" runat="server" Text="Enter location"></asp:Label><asp:TextBox ID="txtAddLocation" TextMode="MultiLine" Columns="8" Rows="4" CssClass="textbox" runat="server"></asp:TextBox>
        <br />
        <asp:Label ID="lblMobile" CssClass="label" runat="server" Text="Enter mobile no"></asp:Label><asp:TextBox ID="txtMobile" CssClass="textbox" runat="server"></asp:TextBox>
        <br />
        </fieldset>
        <br />
        <fieldset class="SizeFieldset">
        <legend>Upload image(optional)</legend>
        <asp:FileUpload ID="FileUpload1" CssClass="button" runat="server" />
        <br />
         </fieldset>
         <br />
        <asp:Button ID="Button1" runat="server" Text="Post add" 
