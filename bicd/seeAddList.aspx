...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="seeAddList.aspx.cs" Inherits="seeAdd" %>
...
<body>
  ...
  <script type="text/javascript" src="http://www.yourweather.co.uk/wid_loader/09e789b327b5ecf43d757a8414785bab"></script>
    ...
    <asp:GridView ID="GridView1" CellPadding="20" CssClass="Grid" runat="server" 
            ...
            ShowHeader="False">
            <Columns>
            <asp:BoundField DataField="AddDate"  DataFormatString="{0:MMMM d, yyyy}"/>
            <asp:ImageField DataImageUrlField="AddPic" ControlStyle-Width="120px" ControlStyle-Height="90px"/>
            <asp:TemplateField  ItemStyle-Width="80%">
            <ItemTemplate>
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("AddTitle", "~/seeAdd.aspx?AddTitle={0}") %>'
                    Text='<%# Eval("AddTitle") %>' />
            </ItemTemplate>
        </asp:TemplateField>
